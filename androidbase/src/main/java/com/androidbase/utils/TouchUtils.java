...
public class TouchUtils {
    ...
    public static abstract class OnTouchUtilsListener implements View.OnTouchListener {
        ...
        private static final int MIN_TAP_TIME = 500;
        ...
        public abstract boolean onMove(View view, @Direction int direction, int x, int y, int dx, int dy, int totalX, int totalY, MotionEvent event);

        public abstract boolean onStop(View view, @Direction int direction, int x, int y, int totalX, int totalY, int vx, int vy, MotionEvent event);
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (maximumFlingVelocity == 0) {
                maximumFlingVelocity = ViewConfiguration.get(v.getContext())
                        .getScaledMaximumFlingVelocity();
            }
            if (minimumFlingVelocity == 0) {
                minimumFlingVelocity = ViewConfiguration.get(v.getContext())
        ...
        public boolean onUtilsMove(View view, MotionEvent event) {
            ...
            boolean consumeMove = onMove(view, direction, x, y, x - lastX, y - lastY, x - downX, y - downY, event);
            lastX = x;
            lastY = y;
            return consumeMove;
        }
