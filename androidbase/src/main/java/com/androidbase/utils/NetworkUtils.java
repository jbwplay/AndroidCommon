...
public final class NetworkUtils {
    ...
    public static boolean isConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) AndroidUtils.getContext()
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) AndroidUtils.getContext()
    ...
    private static boolean isEthernet() {
        final ConnectivityManager cm = (ConnectivityManager) AndroidUtils.getContext()
                .getSystemService(Context.CONNECTIVITY_SERVICE);
        if (cm == null) {
            return false;
        }
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) AndroidUtils.getContext()
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 0 && mListeners.size() == 1) {
                        ...
                        AndroidUtils.getContext()
                                .registerReceiver(NetworkChangedReceiver.getInstance(), intentFilter);
                    }
                }
            });
        }
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 1 && mListeners.size() == 0) {
                        AndroidUtils.getContext()
                                .unregisterReceiver(NetworkChangedReceiver.getInstance());
                    }
                }
            });
        }
