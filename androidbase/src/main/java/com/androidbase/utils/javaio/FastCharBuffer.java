...
public class FastCharBuffer implements CharSequence, Appendable {
    ...
    /**
     * Creates a new <code>char</code> buffer. The buffer capacity is initially 1024
    ...
    /**
     * Creates a new <code>char</code> buffer, with a buffer capacity of the specified
     * size, in bytes.
     *
    ...
    /**
     * Returns current index of inner <code>char</code> array chunk. Represents the index
     * of last used inner array chunk.
     */
    public int index() {
    ...
    /**
     * Returns <code>char</code> inner array chunk at given index. May be used for
