...
public class FastCharArrayWriter extends Writer {
    ...
    /**
     * Creates a new writer. The buffer capacity is initially 1024 bytes, though its size
    ...
    /**
     * Creates a new char array writer, with a buffer capacity of the specified size, in
     * bytes.
     *
    ...
    /**
     * Closing a <code>FastCharArrayWriter</code> has no effect. The methods in this class
    ...
    /**
     * @see java.io.CharArrayWriter#writeTo(Writer)
     */
